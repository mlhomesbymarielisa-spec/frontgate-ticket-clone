    ...
    <nav className="bg-black border-b border-slate-800 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-8 text-sm font-semibold">
          ...
          {/* Neutral Sign Up Button Update */}
          <Link href="/signup" className="bg-white text-black px-6 py-2 rounded-full hover:bg-slate-200 transition-all border border-white">
            Sign Up
          </Link>
        </div>
      </div>
